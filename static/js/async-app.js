...
function initMap() {
  ...
  for (var v in villages) {
    ...
    var villageColor = circleColor(village.t, village.val);
    var villageInfo = new google.maps.InfoWindow({
      ...
      + '<i>Recent Span&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'+days+word+'</i>'
      + '<br />'
      + '<i>Recent Max&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'+days+'</i>'
      + '<br />'
      + '<i>Historical Span&nbsp&nbsp&nbsp&nbsp'+start+'-'+end+'</i>'
      + '<br /><br />'
        + '<table>'
          +'<tr><td>Recent max temp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>'+(parseFloat(village.t)).toFixed(1)+'&deg;C</td></tr>'
          +'<tr><td>Recent max date&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>'+village.rts+'</td></tr>'
          +'<tr><td>Historic max temp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>'+(parseFloat(village.val)).toFixed(2)+'&deg;C</td></tr>'
          +'<tr><td>Historic max date&nbsp&nbsp&nbsp&nbsp&nbsp</td><td>'+village.hts+'</td></tr>'
        + '</table>'
      + '</div>'
    });
    ...
    var villageCircle = new google.maps.Circle({
      //villageColor here
      strokeColor: circleColor(village.t, village.val),
      strokeOpacity: 0.8,
      strokeWeight: 0.5,
      //villageColor here
      // fillColor: 'green',
      fillColor: circleColor(village.t, village.val),
      fillOpacity: 0.35,
      map: map,
